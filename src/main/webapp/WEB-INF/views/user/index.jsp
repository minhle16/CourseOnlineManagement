            ...
            <div class="flex flex-wrap align-items-stretch">
                <div class="icon-box">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">Học cùng chuyên gia</h2>
                    </header><!-- .entry-header -->

                    <div class="entry-content">
                        <p>Chương trình giảng dạy Montessori thể hiện một đề xuất chi tiết để thực hiện được tầm nhìn của tiến sĩ Montessori. </p>
                    </div><!-- .entry-content -->
                ...
                <div class="icon-box">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">Sách và những câu chuyện</h2>
                    </header><!-- .entry-header -->

                    <div class="entry-content">
                        <p>Hệ thống tài liệu Montessori và những câu chuyện về trẻ nhỏ</p>
                    </div><!-- .entry-content -->
                ...
                <div class="icon-box">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">Những khóa học hay</h2>
                    </header><!-- .entry-header -->

                    <div class="entry-content">
                        <p>Tổng hợp những khóa học hay và dễ thực hành nhất dành cho các bậc cha mẹ dạy trẻ theo phương pháp Montessori </p>
                    </div><!-- .entry-content -->
                ...
                <div class="icon-box">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">Thư viện giáo cụ</h2>
                    </header><!-- .entry-header -->

                    <div class="entry-content">
                        <p>Với mỗi bài học có những giáo cụ riêng để trẻ vừa học vừa thực hành ngay tại gia đình nhỏ của mình</p>
                    </div><!-- .entry-content -->
            ...
            <div class="row">
                <div class="col-12">
                    <header class="heading flex justify-content-between align-items-center">
                        <h2 class="entry-title"> Khóa học</h2>

                        <a class="btn mt-4 mt-sm-0" href="${pageContext.request.contextPath}/coursesPage">xem tất cả</a>
                    </header><!-- .heading -->
                </div><!-- .col -->
                    ...
                    <div class="course-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                ...
                                <h2 class="entry-title"><a href="#">Thực hành cuộc sống</a></h2>

                                <div class="entry-meta flex flex-wrap align-items-center">
                                    <div class="course-author"><a href="#">Ms.Montessori </a></div>

                                    <div class="course-date">20 - 04 - 2018</div>
                                </div><!-- .course-date -->
                            </header><!-- .entry-header -->

                            <footer class="entry-footer flex justify-content-between align-items-center">
                                <div class="course-cost">
                                    <span class="free-cost">Miễn phí</span>
                                </div><!-- .course-cost -->
                            </footer><!-- .entry-footer -->
                    ...
                    <div class="course-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                ...
                                <h2 class="entry-title"><a href="#">Địa lý</a></h2>
                            ...
                            <footer class="entry-footer flex justify-content-between align-items-center">
                                <div class="course-cost">
                                    200k <span class="price-drop">300k</span>
                                </div><!-- .course-cost -->
                            </footer><!-- .entry-footer -->
                        </div><!-- .course-content-wrap -->
                    </div><!-- .course-content -->
            ...
            <div class="row">
                <div class="col-12 col-lg-6 align-content-lg-stretch">
                    <header class="heading">
                        <h2 class="entry-title">Giới thiệu chung về LibraryMontessori</h2>

                        <p>Các nguyên tắc nền tảng cho phương pháp sư phạm Montessori xuất hiện từ việc quan sát hoạt động của trẻ em và giám sát thực hành giảng dạy của giáo viên trong môi trường học tập Montessori ở nhiều nơi trên thế giới trong hơn một thế kỷ</p>
                    </header><!-- .heading -->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 order-1 order-lg-2 content-wrap h-100">
                                <div class="entry-content">
                                    <p>Trẻ em là niềm hy vọng và cũng là những hứa hẹn của nhân loại.</p>
                                </div><!-- .entry-content -->

                                <div class="entry-footer">
                                    <h3 class="testimonial-user">Maria Montessori <span></span></h3>
                                </div><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .container -->
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 order-1 order-lg-2 content-wrap h-100">
                                <div class="entry-content">
                                    <p>Đừng bao giờ giúp trẻ việc mà trẻ có thể tự làm được.</p>
                                </div><!-- .entry-content -->
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 order-1 order-lg-2 content-wrap h-100">
                                <div class="entry-content">
                                    <p>Đôi bàn tay là công cụ của trí thông minh loài người</p>
                                </div><!-- .entry-content -->

                                <div class="entry-footer">
                                    <h3 class="testimonial-user">Maria Montessori</h3>
                                </div><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .container -->
            ...
            <div class="row mx-m-25">
                    ...
                    <header class="heading flex flex-wrap justify-content-between align-items-center">
                        ...
                        <nav class="courses-menu mt-3 mt-lg-0">
                            <ul class="flex flex-wrap justify-content-md-end align-items-center">
                                ...
                                <li><a href="#">Thực hành cuộc sống</a></li>
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="#">Sinh học</a></h2>
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="#">Địa chất học</a></h2>
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="#">Cảm giác</a></h2>
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="#">Toán học</a></h2>
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        ...
                        <div class="course-content-wrap">
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="#">Lịch sử</a></h2>
                ...
                <div class="col-12 px-25 flex justify-content-center">
                    <a class="btn" href="${pageContext.request.contextPath}/coursesPage">Xem tất cả khóa học</a>
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </section><!-- .courses-wrap -->
    ...
    <section class="latest-news-events">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <header class="heading flex justify-content-between align-items-center">
                        <h2 class="entry-title">Tin tức và sự kiện mới nhất </h2>
                    </header><!-- .heading -->
                </div><!-- .col -->
